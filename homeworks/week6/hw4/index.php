...
<body>
    ...
    <div class="container">
        <div class="wrapper__form">
            <form class="meg__form" method="POST" action="./add_comment.php">
        ...
        <?php
            ...
            LEFT JOIN enter3017sky_users AS users 
            ...
            <div class="meg__wrap"> 
                <div class="comment__header">
                    <div class="comment__header__left">
                        <div class="commnet__author">
                            <?= escape($row['nickname']) ?>
                        </div> 
                        <div class="commnet__timestmp">
                            <?= $row['created_at']?>
                        </div>
                    </div>
                ...
                <div class="commnet__content">
                    ...
                    <?php } ?>
                        <div class="comment__header">
                            <div class="comment__header__left">
                                <div class="sub-commnet__author">
                                    <?= escape($row_sub['nickname']) ?>
                                </div> 
                                <div class="sub-commnet__timestmp">
                                    <?= $row_sub['created_at']?>
                                </div>
                            </div>
                            <div class="comment__header__right">
                        ...
                        <div class="sub-commnet__content">
                ...
                <div class="wrapper__form">
                    <form class="meg__form" method="POST" action="./add_comment.php">
                        <!-- 這個隱藏的 input，在主留言底下留言的時候，把主留言的id = parent_id，以辨別這是某個主留言底下的子留言 -->
                        <input type="hidden" name="parent_id" value="<?= $parent_id; ?>">
                        <div class='form-row'>
                            <textarea class="content" name='content' type='textarea' placeholder="留言內容" required></textarea>
                        </div>
                        <div class='form-row'>
                            <div class="sub__btn">
                                <input type="submit" class="submit__btn">
