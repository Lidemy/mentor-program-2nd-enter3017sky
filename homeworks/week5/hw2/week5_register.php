...
if (!empty($_POST['username'])) {
    ...
    $sql = "INSERT INTO enter3017sky_user (username, password, nickname)
    ...
    if ($result) {
        ...
        $conn->close();
        header('Location: /enter3017sky/week5/week5_index.php');
}
...
<body class='body__set'>
    ...
    <div class='login__mian'>
        ...
        <!-- required="required" 提交之前填寫輸入字段的提示 -->
            ...
            <a href='/enter3017sky/week5/week5_login.php' style="color:gray; text-decoration: none; font-size: 16px; ">已有帳號？點我登入！<a>
        </form>
    </div>
